...
const CrmSummaryReport = () => {
  ...
  <div className="flex flex-col h-full">
    <div className="card-block1 flex justify-between mb-8">
      <div className="flex-1 mr-4 bg-[#fff] p-4">
        <div>
        <h5 className='text-black text-xl font-medium mt-3 mb-2'>Total Profit</h5>

          <span>12 January 2023 - 12 January 2024</span>
        </div>
        <div className='inline-flex mt-8'>
        <p className='text-3xl font-bold'>{totalProfit}</p>
        <span className='p-3 pl-4 font-medium'>{profitPercentage}</span>
        </div>
        <p className='p-0 cursor-pointer'>
  <span className='border p-1 border-gray-300 text-black m-1 rounded-tl-2xl rounded-br-2xl rounded-tr-2xl font-medium text-sm'>{performanceText}</span>
</p>
