          ...
          <section className="m-4 inline-block">
            ...
            <h2 className="text-sm font-semibold pb-2 border-b border-grey">{"Sales Templates"}</h2>
                    ...
                    <div className=" justify-between mb-4">
                      {[{'btnTxt': 'On Payment', 'target': 'Sales Executive' },{'btnTxt': 'On Lead Assign', 'target': 'Sales Executive' },{'btnTxt': 'On Creation', 'target': 'Customer' },{'btnTxt': 'On Creation', 'target': 'Sales Executive' },{'btnTxt': 'On Creation', 'target': 'Manager' },{'btnTxt': 'On Creation', 'target': 'Administrator' },{'btnTxt': 'On Assignment', 'target': 'Customer' },{'btnTxt': 'On Assignment', 'target': 'Sales Executive' },{'btnTxt': 'On Assignment', 'target': 'Manager' },{'btnTxt': 'On Assignment', 'target': 'Administrator' },{'btnTxt': 'On Transfer', 'target': 'Customer' },{'btnTxt': 'On Transfer', 'target': 'Sales Executive' },{'btnTxt': 'On Transfer', 'target': 'Manager' },{'btnTxt': 'On Transfer', 'target': 'Administrator' },{'btnTxt': 'On De-assignment', 'target': 'Customer' },
