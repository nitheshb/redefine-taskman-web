          ...
          <div className="mr-4 templateList">
            <div className=" flex">
              <div className="flex flex-col">
                ...
                <button
                  className={`templateItem ${
                    subView === 'financestats' ? 'hightlightItem' : ''
                  }`}
                  tabIndex="0"
                  type="button"
                  onClick={() => setSubView('financestats')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">Report</span>
                </button>
                <button
                  className={`templateItem ${
                    subView === 'financeAccessTeam' ? 'hightlightItem' : ''
                  }`}
                  tabIndex="0"
                  type="button"
                  onClick={() => setSubView('financeAccessTeam')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">Accounts Team Access</span>
                </button>
                <button
                  className={`templateItem ${
                ...
                >
                  ...
                  <span className="pt-[5px]">Banker Details</span>
                </button>
              </div>
            </div>
          </div>
