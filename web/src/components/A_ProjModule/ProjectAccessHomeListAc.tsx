              ...
              <div className="flex flex-col">
                <button
                  className={`templateItem ${
                    subView === 'salesAccess' ? 'hightlightItem' : ''
                  }`}
                  type="button"
                  onClick={() => setSubView('salesAccess')}
                >
                  <span className="pr-1">
                    <svg
                  ...
                  <span className="pt-[5px]">Sales</span>
                </button>
                <button
                  className={`templateItem ${
                    subView === 'creditNoteIssuers' ? 'hightlightItem' : ''
                  }`}
                  type="button"
                  onClick={() => setSubView('creditNoteIssuers')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">Credit Note Issuers</span>
                </button>
                <button
                  className={`templateItem ${
                    subView === 'FinAccess' ? 'hightlightItem' : ''
                  }`}
                  type="button"
                  onClick={() => setSubView('FinAccess')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">Accounts</span>
                </button>
                <button
                  className={`templateItem ${
                    subView === 'marketingAccess' ? 'hightlightItem' : ''
                  }`}
                  type="button"
                  onClick={() => setSubView('marketingAccess')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">Marketing</span>
                </button>
                <button
                  className={`templateItem ${
                    subView === 'crmAccess' ? 'hightlightItem' : ''
                  }`}
                  type="button"
                  onClick={() => setSubView('crmAccess')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">CRM</span>
                </button>

                <button
                  className={`templateItem ${
                    subView === 'legalAccess' ? 'hightlightItem' : ''
                  }`}
                  type="button"
                  onClick={() => setSubView('legalAccess')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">Legal</span>
                </button>
                <button
                  className={`templateItem ${
                    subView === 'constructAccess' ? 'hightlightItem' : ''
                  }`}
                  type="button"
                  onClick={() => setSubView('constructAccess')}
                >
                  <span className="pr-1">
                    <svg
                      className="tempalteIcon"
                  ...
                  <span className="pt-[5px]">Construction</span>
                </button>
              </div>
            </div>
          </div>
